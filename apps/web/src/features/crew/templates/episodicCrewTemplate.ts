...
export const episodicCrewTemplate: Omit<CrewTemplate, 'id' | 'createdAt' | 'updatedAt'> = {
  ...
  positions: [
    ...
    { department: 'production', role: 'Co-Executive Producer', required: false, quantity: 1, defaultRate: 2200 },
    { department: 'production', role: 'Supervising Producer', required: false, quantity: 1, defaultRate: 2000 },
    { department: 'production', role: 'Producer', required: true, quantity: 1, defaultRate: 2000 },
    { department: 'production', role: 'Co-Producer', required: false, quantity: 1, defaultRate: 1800 },
    ...
    { department: 'production', role: 'Production Supervisor', required: false, quantity: 1, defaultRate: 900 },
    { department: 'production', role: 'Production Coordinator', required: true, quantity: 1, defaultRate: 600 },
    { department: 'production', role: 'Assistant Production Coordinator', required: false, quantity: 1, defaultRate: 400 },
    ...
    { department: 'production', role: 'Assistant Location Manager', required: false, quantity: 1, defaultRate: 500 },
    ...
    { department: 'camera', role: 'B-Camera Operator', required: false, quantity: 1, defaultRate: 1000 },
    { department: 'camera', role: 'B-Camera 1st AC', required: false, quantity: 1, defaultRate: 700 },
    { department: 'camera', role: 'Drone Operator', required: false, quantity: 1, defaultRate: 900 },
    ...
    { department: 'lighting_grip', role: 'Board Operator', required: false, quantity: 1, defaultRate: 600 },
    ...
    { department: 'lighting_grip', role: 'Dolly Grip', required: false, quantity: 1, defaultRate: 600 },
    { department: 'lighting_grip', role: 'Grip', required: true, quantity: 3, defaultRate: 500 },
    { department: 'lighting_grip', role: 'Swing', required: false, quantity: 1, defaultRate: 500 },
    ...
    { department: 'art', role: 'Assistant Art Director', required: false, quantity: 1, defaultRate: 600 },
    { department: 'art', role: 'Set Decorator', required: true, quantity: 1, defaultRate: 800 },
    { department: 'art', role: 'Lead Person', required: true, quantity: 1, defaultRate: 600 },
    { department: 'art', role: 'Set Dresser', required: true, quantity: 2, defaultRate: 550 },
    ...
    { department: 'art', role: 'Prop Builder', required: false, quantity: 1, defaultRate: 500 },
    { department: 'art', role: 'Scenic Artist', required: false, quantity: 1, defaultRate: 600 },
    { department: 'art', role: 'Construction Coordinator', required: false, quantity: 1, defaultRate: 700 },
    { department: 'art', role: 'Carpenter', required: false, quantity: 2, defaultRate: 500 },
    { department: 'art', role: 'Painter', required: false, quantity: 2, defaultRate: 500 },

    // Wardrobe
    { department: 'wardrobe', role: 'Costume Designer', required: true, quantity: 1, defaultRate: 1000 },
    { department: 'wardrobe', role: 'Assistant Costume Designer', required: false, quantity: 1, defaultRate: 600 },
    ...
    { department: 'wardrobe', role: 'Set Costumer', required: true, quantity: 1, defaultRate: 500 },
    ...
    { department: 'makeup_hair', role: 'Makeup Artist', required: true, quantity: 1, defaultRate: 600 },
    { department: 'makeup_hair', role: 'SFX Makeup Artist', required: false, quantity: 1, defaultRate: 800 },
    { department: 'makeup_hair', role: 'Key Hairstylist', required: true, quantity: 1, defaultRate: 700 },
    { department: 'makeup_hair', role: 'Hairstylist', required: true, quantity: 1, defaultRate: 600 },

    // Transportation
    { department: 'transportation', role: 'Transportation Coordinator', required: true, quantity: 1, defaultRate: 700 },
    { department: 'transportation', role: 'Transportation Captain', required: false, quantity: 1, defaultRate: 600 },
    { department: 'transportation', role: 'Driver', required: true, quantity: 2, defaultRate: 400 },
    { department: 'transportation', role: 'Picture Car Coordinator', required: false, quantity: 1, defaultRate: 600 },
    ...
    // Stunts
    { department: 'stunts', role: 'Stunt Coordinator', required: false, quantity: 1, defaultRate: 1200 },
    { department: 'stunts', role: 'Stunt Performer', required: false, quantity: 2, defaultRate: 900 },
    { department: 'stunts', role: 'Stunt Rigger', required: false, quantity: 1, defaultRate: 700 },
    { department: 'stunts', role: 'Safety Officer', required: false, quantity: 1, defaultRate: 600 },

    // VFX
    { department: 'vfx', role: 'VFX Supervisor', required: false, quantity: 1, defaultRate: 1500 },
    { department: 'vfx', role: 'VFX Producer', required: false, quantity: 1, defaultRate: 1200 },
    { department: 'vfx', role: 'On-Set VFX Supervisor', required: false, quantity: 1, defaultRate: 1200 },
    { department: 'vfx', role: 'VFX PA', required: false, quantity: 1, defaultRate: 250 },

    // Other
    { department: 'other', role: 'Unit Publicist', required: false, quantity: 1, defaultRate: 600 },
    { department: 'other', role: 'Still Photographer', required: false, quantity: 1, defaultRate: 700 },
    ...
    { department: 'other', role: 'Security', required: false, quantity: 1, defaultRate: 350 },
  ],
};
